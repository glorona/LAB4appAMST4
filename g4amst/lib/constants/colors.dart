...
class AppColors {
  static final MaterialColor mainColor = const MaterialColor(
    0xFF162447,
    const <int, Color>{
      50: const Color(0xFF471616),
      100: const Color(0xFF471616),
      200: const Color(0xFF471616),
      300: const Color(0xFF471616),
      400: const Color(0xFF471616),
      500: const Color(0xFF471616),
      600: const Color(0xFF471616),
      700: const Color(0xFF471616),
      800: const Color(0xFF471616),
      900: const Color(0xFF471616),
    },
  );

  //static const PrimaryColor = Color(0xFF0C4B8D);
  static const primaryColor = Color(0xFF471616);
